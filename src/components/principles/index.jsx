                ...
                <div className="about-section">
                    ...
                    <div className="about-container-a">
                        <div className="about-steps">
                            <h1>Principle #4:</h1>
                            <h2>Clarity</h2>
                            <br />What is your compelling vision for your future? What will happen if you don’t accomplish this?
                        </div>
                    </div>
                    <div className="about-container-a">
                        <div className="about-steps">
                    ...
                    <div className="about-container-a">
                        <div className="about-steps">
                            ...
                            <br />Your results in life are solely dependent on YOU. No one else is going to show up and do this for you.
                            <br />
                            <br />“As long as you are alive, you will either live to accomplish your own goals and dreams or be used as a resource to accomplish someone else's.” Grant Cardone
                        </div>
                    </div>
                    <div className="about-container-a">
                        <div className="about-steps">
                            <h1>Principle #7:</h1>
                            <h2>Manage Your Days</h2>
                    ...
                    <div className="about-container-a">
                        <div className="about-steps">
                            ...
                            <br />Know your most important things you must be doing and ensure you are doing those every day. There is a huge difference between how the successful and unsuccessful people act. Everyone has whirlwinds of life. The successful have learned to make sure they are doing the key things and taking care of the rest afterwards. The unsuccessful do the least important first and give the important what time is left over. And the craziest thing: the unsuccessful don't even realize they are doing this!
                        </div>
                    </div>
                    <div className="about-container-a">
                        <div className="about-steps">
                    ...
                    <div className="about-container-a">
                        <div className="about-steps">
                            ...
                            <br />- There is no failure. Only feedback.
                            <br />- Success is on the far side of failure. Therefore, you must go through failure to succeed.
                            <br />- Refer to principle #11
                        </div>
                    </div>
                    <div className="about-container-a">
                        <div className="about-steps">
                    ...
                    <div className="about-container-a">
                        <div className="about-steps">
                            <h1>Principle #14:</h1>
                            <h2>It All Comes Down to the Margin</h2>
                            <br />To invest and start earning compound interest- you must save money each and every month- this is called the margin. We talk a ton about this in our Master Classes.
                        </div>
                    </div>
                    <div className="about-container-a">
                        <div className="about-steps">
